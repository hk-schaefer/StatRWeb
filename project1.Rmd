...
Is the income level (`income2`) correlated with general health (`genhth`)?\
...
```{r make mosaic plot, fig.width=12, fig.asp=0.6, warning=FALSE}
...
```{r make mosaic plot 2, fig.width=10, fig.asp=0.5}
...
```{r box plot q2c, fig.width=12, fig.asp=0.6}
...
```{r scatter plot q3b, fig.width=10, fig.asp=0.6, warning=FALSE}
# create scatter plot 
...
df_q3_sampled %>% 
  ...
  labs(title = "Relationship between Physical Activity and BMI",
       subtitle = "Data sampled by 5% from original, n = 14,825")+
...
```{r q3c, fig.width=12, fig.asp=0.6, warning=FALSE}
