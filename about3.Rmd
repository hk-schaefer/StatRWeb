...
The objective of the 3rd project in this course was to apply the learned contents of "Multiple linear regression and modeling". Skills learned are:\

`Exploratory Data Analysis`, `Variable Selection`, `Linear Regression`, `Regression`, `Model Selection`,  `Inference`, `Prediction`, `Statistical Thinking`, `R programming`\
\
\
...
- [LinkedIn](https://www.linkedin.com/in/hartmut-schaefer/)
\
\
